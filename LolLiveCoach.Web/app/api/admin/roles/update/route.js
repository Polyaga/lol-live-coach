...
import { updateAdminRole } from "../../../../../lib/admin-store";
...
export async function POST(request) {
  ...
  try {
    await updateAdminRole(asText(formData, "id"), {
  ...
  return NextResponse.redirect(buildAdminRedirectUrl(request, { ...redirectParams, notice: "role-updated" }), 303);
}
